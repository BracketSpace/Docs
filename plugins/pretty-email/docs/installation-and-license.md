...
![WordPress plugin upload interface for installing Pretty Email](../assets/wordpress-plugin-upload-interface.png)
...
2. Go to `View Details and Downloads` of your Pretty Email plugin payment
   ...
   ![BracketSpace account payment details and download access](../assets/bracketspace-account-payment-details.png)
3. You'll find a plugin download link in the `Products` table.

   ![BracketSpace products download table with Pretty Email plugin link](../assets/bracketspace-download-products-table.png)
...
2. Navigate to `Settings` tab
   ...
   ![Pretty Email settings tab navigation in WordPress admin](../assets/pretty-email-settings-tab-navigation.png)

   Or use the link in the notice.

   ![Pretty Email license activation notice in WordPress dashboard](../assets/pretty-email-license-activation-notice.png)
3. Provide your license key in the `License` box.

   ![Pretty Email license key input field in plugin settings](../assets/pretty-email-license-key-input-field.png)
